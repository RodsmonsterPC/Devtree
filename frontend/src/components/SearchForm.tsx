...
const SearchForm = () => {
  ...
  <div className="relative flex items-center  bg-white  px-2">
    ...
    <input
      type="text"
      id="handle"
      className="outline-none border-none bg-transparent p-2 focus:ring-0 flex-1"
  ...
  <div className="mt-10">
    ...
    {mutation.data && <p className="text-center text-cyan-500 font-black">
        ...
        {mutation.data} ir a <Link to={'/auth/register'} state={{handle: slugify(handle)}} > <span className="text-cyan-950">Registro</span> </Link>
    </p> }
  </div>
